...
# ==============================================================================
# GLOBAL FINANCIAL SIGNATURE REGISTRY (FIN-NEXUS)
# ==============================================================================
GLOBAL_FINANCE_MATRIX=(
    # --- 1. IBAN (ISO 13616) ---
    '\b[A-Z]{2}[0-9]{2}([A-Z0-9][[:space:]]*){10,30}[A-Z0-9]\b'
    
    # --- 2. SWIFT/BIC (8 или 11 символов) ---
    ...
    # --- 5. CREDIT CARD (13-16 знаков) ---
    '\b[4-6][0-9]{3}([[:space:].-]?[0-9]{4}){3}\b'
)
