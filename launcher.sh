...
# ==============================================================================
# GLOBAL PHONE MASK MATRIX (BANKING & GEO VALIDATION)
# ==============================================================================
GLOBAL_PHONE_MATRIX=(
    # --- International Standards (E.164) ---
    "+[0-9]{1,3}[[:space:]\.-]?[0-9]{3,4}[[:space:]\.-]?[0-9]{2,3}[[:space:]\.-]?[0-9]{2,3}"
    
    # --- Localized Bank/Support Formats (RU/EU Focus) ---
    "8[[:space:]\.-]?\([0-9]{3}\)[[:space:]\.-]?[0-9]{3}[[:space:]\.-]?[0-9]{2}[[:space:]\.-]?[0-9]{2}"
    "7[[:space:]\.-]?[0-9]{3}[[:space:]\.-]?[0-9]{3}[[:space:]\.-]?[0-9]{2}[[:space:]\.-]?[0-9]{2}"
    
    # --- Short Codes (Banking/Service) ---
    "[0-9]{3,5}"
)
